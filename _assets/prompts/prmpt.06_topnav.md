...
In this new project we added 'layouts/includes/TopNav.tsx'
        ...
        <>
            <div id="TopNav" className="fixed bg-white z-30 flex items-center w-full border-b h-[60px]">
                <div className={`flex items-center justify-between gap-6 w-full px-4 mx-auto ${pathname == '/' ? 'max-w-[1150px]' : ''}`}>
                    ...
                    <div className="relative hidden md:flex item-center justify-end bg-[#F1F1F1] p-1 rounded-full max-w-[430px] w-full">
                            ...
                            <div className="p-1">
                                ...
                                >
                                    <div className="flex items-center">
                                        <img src="https://placehold.co/40" className="rounded-md" width="40" />
                        ...
                        { true ? (
                            ...
                            <div className="flex items-center">
                                <div className="relative">
                                    ...
                                    >
                                        <img src="https://placehold.co/35" className="rounded-full w-[35px] h-[35px]"/>
                                    </button>
...
Then we imported the file into the 'layouts/MainLayout.tsx'
